...
public class TaskMonthlyResultWithRank {
	...
	public TaskMonthlyResult getTaskMonthlyResult() {
		return taskMonthlyResult;
	}
	public void setTaskMonthlyResult(TaskMonthlyResult taskMonthlyResult) {
		this.taskMonthlyResult = taskMonthlyResult;
	}
